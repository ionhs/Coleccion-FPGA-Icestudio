{
  "version": "1.2",
  "package": {
    "name": "Contador-8bits-up-rst-system",
    "version": "0.1",
    "description": "Contador del sistema, módulo M, ascendente, de 8 bits, con reset ",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "f5d5ef63-bdff-487f-98d8-e2b29576b074",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[7:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "f5d5ef63-bdff-487f-98d8-e2b29576b074",
            "port": "in"
          },
          "size": 8
        }
