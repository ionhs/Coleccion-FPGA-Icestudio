{
  "version": "1.2",
  "package": {
    "name": "ServoBit-Tower-Pro-SG90",
    "version": "0.1",
    "description": "ServoBit para micrservo TowerPro-SG90. Controlador de 1 bit para mover un servo a 2 posiciones. El ángulo entre una posición y otra la define el usuario",
