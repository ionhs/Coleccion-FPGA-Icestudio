{
  ...
  "package": {
    ...
    "version": "0.1",
    "description": "Decodificador de 3 a 8 (Binario a Decimal) de lógica positiva, con salida en bus",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "40568a49-cb93-4322-8733-2aa1f2c7ca3e",
          "type": "basic.output",
          "data": {
            "name": "i",
            "range": "[7:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "40568a49-cb93-4322-8733-2aa1f2c7ca3e",
            "port": "in"
          },
          "size": 8
        }
